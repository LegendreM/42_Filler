...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2016/12/15 09:33:40 by jle-mene          #+#    #+#             */
/*   Updated: 2016/12/15 09:33:42 by jle-mene         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ai_dv.h"

static t_coord	opp_dist(t_coord *check, t_coord pos, \
							t_params *params, int *dist)
{
	int		tmp_dist;
	t_coord to_play;
...
static int		go_around(t_coord *to_play, int pos_size, \
